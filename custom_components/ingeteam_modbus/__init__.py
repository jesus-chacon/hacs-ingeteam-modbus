...
class IngeteamModbusHub:
    ...
    def read_modbus_data_pv_field(self, registers, external_pv_data):
        ...
        self.data["pv_power"] = pv1_power + pv2_power + external_pv_power
    ...
    def parse_totals(self):
        ...
        if self.data["em_active_power"] > 0:
            ...
            self.data["imported_power"] = abs(self.data["em_active_power"])
        else:
            self.data["exported_power"] = abs(self.data["em_active_power"])
