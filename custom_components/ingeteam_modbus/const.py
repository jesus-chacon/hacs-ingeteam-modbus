...
BATTERY_SENSOR_TYPES = {
    ...
    "Battery_Charging_Power": ["Battery Charging Power", "battery_charging_power", "W", "mdi:battery-charging"],
    "Battery_Charging_Energy": ["Battery Charging Energy", "battery_charging_energy", "Wh", "mdi:battery-charging", "battery_charging_power"],
    "Battery_Discharging_Power": ["Battery Discharging Power", "battery_discharging_power", "W", "battery-charging-medium"],
    "Battery_Discharging_Energy": ["Battery Discharging Energy", "battery_discharging_energy", "Wh", "battery-charging-medium", "battery_discharging_power"],
